...
public final class Views {
  ...
  public record PrivatePlayerView(
      ...
      int fortifyTokenStockpile,
      int temporaryFortifyTokens,
      int freeFortifyAssignmentsRemaining,
      Map<String, Integer> assignedFortifyTokens,
      Map<String, Integer> temporaryAssignedFortifyTokens,
